template = mt"""
{
	...
	"colors": {
        ...
        "terminal.border": "{{u1}}",
        "terminal.ansiMagenta": "{{c1}}",
        "terminal.ansiBlue": "{{c2}}",
        "terminal.ansiGreen": "{{c3}}",
        "terminal.ansiYellow": "{{c4}}",
        "terminal.ansiRed": "{{c5}}",
        "terminal.ansiBrightMagenta": "{{s1}}",
        "terminal.ansiBrightBlue": "{{s2}}",
        "terminal.ansiBrightGreen": "{{s3}}",
        "terminal.ansiBrightYellow": "{{s4}}",
        "terminal.ansiBrightRed": "{{s5}}",
